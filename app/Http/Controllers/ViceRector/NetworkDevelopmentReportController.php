...
class NetworkDevelopmentReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('vice_rector.network_developments_report.index', compact('data'));
    }
    ...
    public function showByIndex($year, $month)
    {
        ...
        return view('vice_rector.network_developments_report.show_by_index', compact('data', 'year', 'month'));
    }
    ...
    {   
        ...
        return view('vice_rector.network_developments_report.show', compact('networkTroubleshooting'));
    }
