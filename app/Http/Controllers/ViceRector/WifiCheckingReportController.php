...
class WifiCheckingReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('vice_rector.wifi_checking_report.index', compact('data'));
    }
    ...
    public function showByIndex($building)
    {
        ...
        return view('vice_rector.wifi_checking_report.show_by_index', compact('data', 'buildingName'));
    }
    ...
    {
        $wifiChecking = $id;
        return view('vice_rector.wifi_checking_report.show', compact('wifiChecking'));
    }
