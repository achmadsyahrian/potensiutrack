...
class WebMaintenanceReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('vice_rector.web_maintenance_report.index', compact('data'));
    }
    ...
    public function showByIndex($year)
    {
        ...
        return view('vice_rector.web_maintenance_report.show_by_index', compact('data', 'year'));
    }
    ...
    {
        $web_maintenance = $id;
        return view('vice_rector.web_maintenance_report.show', compact('web_maintenance'));
    }
