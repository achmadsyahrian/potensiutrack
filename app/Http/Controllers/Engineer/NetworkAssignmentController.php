...
class NetworkAssignmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('engineer.network_assignment.index', compact('data', 'divisions'));
    }
    ...
    public function verify(NetworkAssignment $id, Request $request)
    {
        ...
        $signatureResult = $this->saveSignature($validated['engineer_signature']);

        $id->engineer_signature = $signatureResult;
        $id->save();
