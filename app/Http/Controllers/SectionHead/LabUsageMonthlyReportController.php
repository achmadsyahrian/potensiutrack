...
class LabUsageMonthlyReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('section_head.lab_usages_report.index', compact('data'));
    }
    ...
    public function showByIndex($year, $month, $lab)
    {
        ...
        return view('section_head.lab_usages_report.show_by_index', compact('data', 'year', 'month', 'labName'));
    }

    public function show(LabUsage $id)
    {
        $labUsage = $id;
        return view('section_head.lab_usages_report.show', compact('labUsage'));
    }
