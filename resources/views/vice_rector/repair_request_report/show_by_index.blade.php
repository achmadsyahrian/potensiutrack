   ...
   <div class="container-xl">
      <div class="row g-2 align-items-center">
         <div class="col">
            <div class="page-pretitle">
               <ol class="breadcrumb breadcrumb-arrows">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('vicerector.repairrequestsreport.index') }}">Perawatan & Perbaikan PC Staff</a></li>
         ...
         {{-- <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
               <a href="{{ route('vicerector.repairrequestsreport.index') }}" class="btn btn-warning d-none d-sm-inline-block">
               ...
               <a href="{{ route('vicerector.repairrequestsreport.index') }}" class="btn btn-secondary d-sm-none btn-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-chevrons-left">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    <path d="M11 7l-5 5l5 5" />
                    <path d="M17 7l-5 5l5 5" /></svg>
                    ...
                    <td>
                     ...
                     <td>
                        <div class="btn-list justify-content-end flex-nowrap">
                           <a href="{{ route('vicerector.repairrequestsreport.show', ['id' => $item]) }}"
