            ...
            <table class="table card-table table-vcenter text-nowrap datatable" id="my-table">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <x-verify-signature route="{{ route('vicerector.webmaintenancesreport.verify', ['year' => $item->year]) }}" method='post' id='{{ $loop->index }}' title="Paraf Wakil Rektor 2" name="wakil_rektor_signature"></x-verify-signature>
                  </tr>
                  @empty
                  <tr>
                     <td colspan="6">
