         ...
         <div class="col">
            <div class="page-pretitle">
               <ol class="breadcrumb breadcrumb-arrows">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('vicerector.wificheckingsreport.index') }}">Pengecekan Wifi</a></li>
                  ...
                  <h2 class="mb-4">Data Permohonan</h2>
                     ...
                     <div class="card-footer bg-transparent mt-auto">
                           <div class="btn-list justify-content-end">
                              <a href="{{ route('vicerector.wificheckingsreport.index') }}" class="btn">
                                 Kembali
                              </a>
                           </div>
                     </div>
