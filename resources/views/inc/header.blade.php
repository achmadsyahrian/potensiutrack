      ...
      <div class="collapse navbar-collapse" id="navbar-menu">
         <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
            <ul class="navbar-nav">
               ...
               <li class="nav-item dropdown {{ request()->routeIs(['puskom.webdevelopment.index', 'puskom.webdevelopment.show', 'puskom.webmaintenance.index', 'puskom.webmaintenance.show', 'puskom.appchecking.index', 'puskom.appchecking.showByMonthAndYear', 'puskom.webassignment.index', 'puskom.webassignment.show']) ? 'active' : '' }}">
                  <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false">
                     <span class="nav-link-icon d-md-none d-lg-inline-block">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-device-analytics">
                           <path stroke="none" d="M0 0h24v24H0z" fill="none" />
               ...
               <li class="nav-item {{ request()->routeIs(['headaslab.labusagesreport.index', 'headaslab.labusagesreport.showByIndex', 'headaslab.labusagesreport.show']) ? 'active' : ''}}">
                  <a class="nav-link" href="{{ route('headaslab.labusagesreport.index') }}">
                     <span class="nav-link-icon d-md-none d-lg-inline-block">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-list-details">
                           <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                           <path d="M13 5h8" />
               ...
               <li class="nav-item {{ request()->routeIs(['headaslab.labrequestsreport.index', 'headaslab.labrequestsreport.showByIndex', 'headaslab.labrequestsreport.show']) ? 'active' : ''}}">
                  <a class="nav-link" href="{{ route('headaslab.labrequestsreport.index') }}">
                     <span class="nav-link-icon d-md-none d-lg-inline-block">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-list-details">
                           <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                           <path d="M13 5h8" />
               ...
               <li class="nav-item {{ request()->routeIs(['headaslab.labdailychecksreport.index', 'headaslab.labdailychecksreport.showByIndex', 'headaslab.labdailychecksreport.show']) ? 'active' : ''}}">
                  <a class="nav-link" href="{{ route('headaslab.labdailychecksreport.index') }}">
                     <span class="nav-link-icon d-md-none d-lg-inline-block">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-list-details">
                           <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                           <path d="M13 5h8" />
