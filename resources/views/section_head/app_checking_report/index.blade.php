                    ...
                    <td>
                     ...
                     <td>
                        <div class="btn-list justify-content-end flex-nowrap">
                           <a href="{{ route('sectionhead.appcheckingsreport.show', ['id' => $item->id]) }}"
                     ...
                     <x-verify-signature route="{{ route('sectionhead.appcheckingsreport.verify', ['id' => $item->id]) }}" method='post' id='{{ $loop->index }}' title="Paraf Kabag" name="kabag_signature"></x-verify-signature>
                  </tr>
                  @empty
                  <tr>
                     <td colspan="6">
