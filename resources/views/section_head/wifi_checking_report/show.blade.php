         ...
         <div class="col">
            <div class="page-pretitle">
               <ol class="breadcrumb breadcrumb-arrows">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('sectionhead.wificheckingsreport.index') }}">Pengecekan Wifi</a></li>
                  ...
                  <h2 class="mb-4">Data Permohonan</h2>
                     ...
                     <div class="card-footer bg-transparent mt-auto">
                           <div class="btn-list justify-content-end">
                              <a href="{{ route('sectionhead.wificheckingsreport.index') }}" class="btn">
                                 Kembali
                              </a>
                           </div>
                     </div>
  ...
  $(document).ready(function() {
    ...
    $('#add-lantai3').click(function() {
      ...
      function addNewRowFloor1(accessPointNumber) {
        ...
        var description = (floor1Data && floor1Data['description'].length > (accessPointNumber - 1)) ? floor1Data['description'][accessPointNumber - 1] : '';
          ...
          var newRow = '<tr>' +
              ...
              '<td><input type="text" style="width:230px;" class="form-control" readonly name="floor1_device_name[]"  value="' + deviceName + '"  placeholder="Masukkan nama perangkat"> <input type="hidden" name="floor1_accesspoint[]" value="Accesspoint ' + accessPointNumber + '"></td>' +
              '<td><input type="text" style="width:200px;" class="form-control" readonly name="floor1_condition[]" value="' + condition + '" placeholder="Masukkan kondisi perangkat"></td>' +
              '<td><input type="text" style="width:230px;" class="form-control" readonly name="floor1_description[]" value="' + description + '" placeholder="Keterangan"></td>' +
              '</tr>';
      ...
      function addNewRowFloor2(accessPointNumber) {
          ...
          var newRow = '<tr>' +
            '<td>Accesspoint ' + accessPointNumber + '</td>' + // No floor number prefix
            '<td><input type="text" style="width:230px;" class="form-control" readonly name="floor2_device_name[]" value="' + deviceName + '" placeholder="Masukkan nama perangkat"> <input type="hidden" name="floor2_accesspoint[]" value="Accesspoint ' + accessPointNumber + '"></td>' +
            '<td><input type="text" style="width:200px;" class="form-control" readonly name="floor2_condition[]" value="' + condition + '" placeholder="Masukkan kondisi perangkat"></td>' +
            '<td><input type="text" style="width:230px;" class="form-control" readonly name="floor2_description[]" value="' + description + '" placeholder="Keterangan"></td>' +
            '</tr>';
      ...
      function addNewRowFloor3(accessPointNumber) {
          ...
          var newRow = '<tr>' +
            '<td>Accesspoint ' + accessPointNumber + '</td>' + // No floor number prefix
            '<td><input type="text" style="width:230px;" class="form-control" readonly name="floor3_device_name[]" value="' + deviceName + '" placeholder="Masukkan nama perangkat"> <input type="hidden" name="floor3_accesspoint[]" value="Accesspoint ' + accessPointNumber + '"></td>' +
            '<td><input type="text" style="width:200px;" class="form-control" readonly name="floor3_condition[]" value="' + condition + '" placeholder="Masukkan kondisi perangkat"></td>' +
            '<td><input type="text" style="width:230px;" class="form-control" readonly name="floor3_description[]" value="' + description + '" placeholder="Keterangan"></td>' +
            '</tr>';
      ...
      function addNewRowFloor4(accessPointNumber) {
        ...
        var newRow = '<tr>' +
          '<td>Accesspoint ' + accessPointNumber + '</td>' + // No floor number prefix
          '<td><input type="text" style="width:230px;" class="form-control" readonly name="floor4_device_name[]" value="' + deviceName + '" placeholder="Masukkan nama perangkat"> <input type="hidden" name="floor4_accesspoint[]" value="Accesspoint ' + accessPointNumber + '"></td>' +
          '<td><input type="text" style="width:200px;" class="form-control" readonly name="floor4_condition[]" value="' + condition + '" placeholder="Masukkan kondisi perangkat"></td>' +
          '<td><input type="text" style="width:230px;" class="form-control" readonly name="floor4_description[]" value="' + description + '" placeholder="Keterangan"></td>' +
          '</tr>';
