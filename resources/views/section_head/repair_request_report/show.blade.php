            ...
            <div class="col">
                <div class="page-pretitle">
                    <ol class="breadcrumb breadcrumb-arrows">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('sectionhead.repairrequestsreport.index') }}">Perawatan &
                                Perbaikan PC Staff</a></li>
               ...
               <div class="card-body">
                  ...
                  <div class="row g-3 mt-4">
                     <div class="col-lg-6">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control @error('inventory_code') is-invalid @enderror" name="inventory_code" placeholder="Masukkan kode" value="{{ $repairRequest->inventory_code }}" autocomplete="off" readonly>
                     ...
                     <div class="col-lg-4">
                        <div class="mb-3">
                           ...
                           <textarea data-bs-toggle="autosize" placeholder="Ketikkan disini" class="form-control @error('fault_description') is-invalid @enderror" name="fault_description" id="" cols="" rows="1" readonly>{{ $repairRequest->fault_description }}</textarea>
                     ...
                     <div class="col-lg-4">
                        <div class="mb-3">
                           ...
                           <div class="row g-2">
                              <div class="col">
                                 <input type="date" class="form-control @error('return_date') is-invalid @enderror" name="return_date" value="{{ $repairRequest->return_date }}" autocomplete="off">
                                 <x-invalid-feedback field='return_date'></x-invalid-feedback>
                              </div>
                              <div class="col-auto align-self-center">
                                 <span class="form-help" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="<p>Silakan isi kolom ini ketika sudah melakukan perbaikan.</p>" data-bs-html="true">?</span>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-4">
                        <div class="mb-3">
                           ...
                           <div class="row g-2">
                              <div class="col">
                                 <textarea data-bs-toggle="autosize" placeholder="Ketikkan disini" class="form-control @error('repair_solution') is-invalid @enderror" name="repair_solution" id="" cols="" rows="1">{{ $repairRequest->repair_solution }}</textarea>
                                 <x-invalid-feedback field='repair_solution'></x-invalid-feedback>
                              </div>
                              <div class="col-auto align-self-center">
                                 <span class="form-help" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="<p>Harap isilah kolom ini dengan deskripsi perbaikan yang telah dilakukan, jika sudah melakukan perbaikan.</p>" data-bs-html="true">?</span>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="card-footer bg-transparent mt-auto">
                     <div class="btn-list justify-content-end">
                        <a href="{{ route('sectionhead.repairrequestsreport.index') }}" class="btn">
                           Kembali
                        </a>
                     </div>
                  </div>
