...
<div class="page-header d-print-none">
   <div class="container-xl">
      <div class="row g-2 align-items-center">
         ...
         <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
               <a href="{{ route('sectionhead.repairrequestsreport.index') }}" class="btn btn-secondary d-none d-sm-inline-block">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
                     <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                  ...
                  <tr>
                     ...
                     <td>
                        <div class="btn-list justify-content-end flex-nowrap">
                           <a href="{{ route('sectionhead.repairrequestsreport.showByIndex', ['year' => $item->year, 'month' => $item->month]) }}"
                     ...
                     <x-verify-signature route="{{ route('sectionhead.repairrequestsreport.verify', ['year' => $item->year, 'month' => $item->month]) }}" method='post' id='{{ $loop->index }}' title="Paraf Kabag" name="kabag_signature"></x-verify-signature>
                  </tr>
                  @empty
                  <tr>
                     <td colspan="6">
