         ...
         <div class="col">
            <div class="page-pretitle">
               <ol class="breadcrumb breadcrumb-arrows">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('sectionhead.webmaintenancesreport.index') }}">Permohonan Maintenance Web Aplikasi</a></li>
               ...
               <div class="card-body">
                  ...
                  <div class="row g-3 mt-4">
                     ...
                     <div class="col-lg-6">
                        <div class="mb-3">
                           ...
                           <div class="row g-2">
                              <div class="col">
                                 <input type="text" class="form-control @error('handling') is-invalid @enderror" name="handling" value="{{ $web_maintenance->handling ?? '--' }}" autocomplete="off">
                     ...
                     <div class="col-lg-6">
                        <div class="mb-3">
                           <label class="form-label">Penanganan</label>
                           <input type="text" class="form-control" value="{{ $web_maintenance->handling }}" readonly>
                        </div>
                     </div>
                     @endif
                  </div>
                  <div class="card-footer bg-transparent mt-auto">
                     <div class="btn-list justify-content-end">
                        <a href="{{ route('sectionhead.webmaintenancesreport.index') }}" class="btn">
                           Kembali
                        </a>
                        @if ($web_maintenance->status == 1)
