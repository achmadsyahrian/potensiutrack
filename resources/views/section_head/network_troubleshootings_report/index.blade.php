                  ...
                  <tr>
                     ...
                     <td>
                        <div class="btn-list justify-content-end flex-nowrap">
                           <a href="{{ route('sectionhead.networktroubleshootingsreport.showByIndex', ['year' => $item->year]) }}"
                     ...
                     <x-verify-signature route="{{ route('sectionhead.networktroubleshootingsreport.verify', ['year' => $item->year]) }}" method='post' id='{{ $loop->index }}' title="Paraf Kabag" name="kabag_signature"></x-verify-signature>
                  </tr>
                  @empty
                  <tr>
                     <td colspan="6">
