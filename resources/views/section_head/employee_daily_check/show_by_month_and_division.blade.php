   ...
   <div class="container-xl">
      <div class="row g-2 align-items-center">
         <div class="col">
            <div class="page-pretitle">
               <ol class="breadcrumb breadcrumb-arrows">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('sectionhead.employeepcdailychecks.index') }}">Pemeriksaan PC Harian Staff</a></li>
         ...
         {{-- <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
               <a href="{{ route('sectionhead.employeepcdailychecks.index') }}" class="btn btn-warning d-none d-sm-inline-block">
                    ...
                    <td>
                     ...
                     <td>
                        <div class="btn-list justify-content-end flex-nowrap">
                           <a href="{{ route('sectionhead.employeepcdailychecks.show', ['id' => $item]) }}"
