   ...
   <div class="container-xl">
       <div class="row g-2 align-items-center">
           <div class="col">
               <div class="page-pretitle">
                  <ol class="breadcrumb breadcrumb-arrows">
                     ...
                     <li class="breadcrumb-item active"><a href="#">Permohonan Pengembangan Web Aplikasi</a></li>
                  </ol>
               </div>
               <h2 class="page-title">
                   Potensi Utama Track
         ...
         <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
               <a href="{{ route('puskom.webdevelopment.index') }}" class="btn btn-secondary d-none d-sm-inline-block">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
                     <path stroke="none" d="M0 0h24v24H0z" fill="none" />
               ...
               <a href="{{ route('puskom.webdevelopment.index') }}" class="btn btn-secondary d-sm-none btn-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
                     <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                     <path d="M20 11a8.1 8.1 0 0 0 -15.5 -2m-.5 -4v4h4" />
                     <path d="M4 13a8.1 8.1 0 0 0 15.5 2m.5 4v-4h-4" /></svg>
      ...
      <div class="card">
         ...
         <div class="table-responsive">
            <table class="table card-table table-vcenter text-nowrap datatable" id="my-table">
               ...
               <tbody>
                  @forelse ($webDevelopments as $item)
                      <tr>
                        </td>
                        <td><span class="text-muted">{{ ($webDevelopments->currentPage() - 1) * $webDevelopments->perPage() + $loop->iteration }}</span></td>
                        <td>
                        ...
                        <td>
                           <div class="btn-list justify-content-end flex-nowrap">
                              <a href="{{ route('puskom.webdevelopment.show', ['web_development' => $item->id]) }}" class="btn btn-outline-info">
                                 Lihat
                              </a>
                        ...
                        <x-confirm-modal route="{{ route('puskom.webdevelopment.destroy', ['web_development' => $item->id]) }}" method='delete' id='{{ $item->id }}'></x-confirm-modal>
                     </tr>
                  @empty
                     <tr>
                        <td colspan="6">
         ...
         <x-pagination :data="$webDevelopments" />
      </div>
   </div>
</div>

@include('components.puskom.web_development.modal')
@include('components.puskom.web_development.modal-search')
@endsection