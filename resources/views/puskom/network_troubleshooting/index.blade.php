...
<div class="page-header d-print-none">
   <div class="container-xl">
       <div class="row g-2 align-items-center">
         ...
         <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
               <a href="{{ route('puskom.networktroubleshooting.index') }}" class="btn btn-secondary d-none d-sm-inline-block">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
                     <path stroke="none" d="M0 0h24v24H0z" fill="none" />
               ...
               <a href="{{ route('puskom.networktroubleshooting.index') }}" class="btn btn-secondary d-sm-none btn-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
                     <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                     <path d="M20 11a8.1 8.1 0 0 0 -15.5 -2m-.5 -4v4h4" />
                     <path d="M4 13a8.1 8.1 0 0 0 15.5 2m.5 4v-4h-4" /></svg>
      ...
      <div class="card">
         ...
         <div class="table-responsive">
            <table class="table card-table table-vcenter text-nowrap datatable" id="my-table">
               ...
               <tbody>
                  @forelse ($networkTroubleshooting as $item)
                      <tr>
                        </td>
                        <td><span class="text-muted">{{ ($networkTroubleshooting->currentPage() - 1) * $networkTroubleshooting->perPage() + $loop->iteration }}</span></td>
                        <td>
                        ...
                        <td>
                           <div class="btn-list justify-content-end flex-nowrap">
                              <a href="{{ route('puskom.networktroubleshooting.edit', ['network_troubleshooting' => $item->id]) }}" class="btn btn-outline-info">
                                 Lihat
                              </a>
                        ...
                        <x-confirm-modal route="{{ route('puskom.networktroubleshooting.destroy', ['network_troubleshooting' => $item->id]) }}" method='delete' id='{{ $item->id }}'></x-confirm-modal>
                     </tr>
                  @empty
                     <tr>
                        <td colspan="6">
         ...
         <x-pagination :data="$networkTroubleshooting" />
      </div>
   </div>
</div>

@include('components.puskom.network_troubleshooting.modal')
@include('components.puskom.network_troubleshooting.modal-search')
@endsection