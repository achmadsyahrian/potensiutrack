    ...
    <div class="container-xl">
        <div class="card">
            <div class="row row-deck row-cards">
                <form action="{{ route('puskom.webmaintenance.markAsComplete', ['id' => $web_maintenance]) }}" method="post">
                    @csrf
                    @method('patch')
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ \Carbon\Carbon::parse($web_maintenance->date)->locale('id_ID')->isoFormat('D MMMM YYYY') }}" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea data-bs-toggle="autosize" placeholder="Ketikkan disini"
                                            class="form-control @error('error') is-invalid @enderror" id="" cols=""
                                            rows="1" readonly>{{ $web_maintenance->error }}</textarea>
                                    </div>
                                </div>
                                @if ($web_maintenance->status == 1)
                                            ...
                                            <div class="row g-2">
                                                <div class="col">
                                                    <input type="date" class="form-control @error('finish_date') is-invalid @enderror"
                                                        name="finish_date" value="{{ $web_maintenance->finish_date }}" autocomplete="off">
                                                ...
                                                <div class="col-auto align-self-center">
                                                    <span class="form-help" data-bs-toggle="popover" data-bs-placement="top"
                                                        data-bs-content="<p>Silakan isi kolom ini ketika sudah selesai.</p>"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="row g-2">
                                                <div class="col">
                                                    <input type="text" class="form-control @error('handling') is-invalid @enderror"
                                                        name="handling" value="{{ $web_maintenance->handling }}" autocomplete="off">
                                                    <x-invalid-feedback field='handling'></x-invalid-feedback>
                                                </div>
                                                <div class="col-auto align-self-center">
                                                    <span class="form-help" data-bs-toggle="popover" data-bs-placement="top"
                                                        data-bs-content="<p>Silakan isi kolom ini ketika sudah selesai.</p>"
