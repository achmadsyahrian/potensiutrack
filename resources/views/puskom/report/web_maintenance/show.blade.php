         ...
         <div class="col">
            <div class="page-pretitle">
               <ol class="breadcrumb breadcrumb-arrows">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('puskom.webmaintenancesreport.index') }}">Permohonan Maintenance Web Aplikasi</a></li>
               ...
               <div class="card-body">
                  ...
                  <div class="card-footer bg-transparent mt-auto">
                     <div class="btn-list justify-content-end">
                        <a href="{{ route('puskom.webmaintenancesreport.index') }}" class="btn">
                           Kembali
                        </a>
                        @if ($web_maintenance->status == 1)
