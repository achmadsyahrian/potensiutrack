            ...
            <div class="col">
                <div class="page-pretitle">
                    <ol class="breadcrumb breadcrumb-arrows">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('puskom.appcheckingsreport.index') }}">Pengecekan Web Aplikasi</a></li>
                  ...
                  <div class="card-body">
                        ...
                        <div class="card-footer bg-transparent mt-auto">
                           <div class="btn-list justify-content-end">
                              <a href="{{ route('puskom.appcheckingsreport.index') }}" class="btn">
                                    Kembali
                              </a>
                           </div>
                        </div>
