...
<head>
   ...
   <title>Print Permohonan Penanganan Gangguan Jaringan Utama</title>
   <style>
      body {
         ...
         <thead>
            <tr>
               ...
               <td class="header-cell" style="width: 30%;">
                  <strong>NO. DOKUMEN</strong><br>F-/SPMI/27-02-02
               </td>
            </tr>
            <tr>
               <td colspan="2" rowspan="2" class="header-cell">
                  <strong>JUDUL</strong><br>PERMOHONAN PENANGANAN GANGGUAN JARINGAN UTAMA
               </td>
               <td class="">
         ...
         <table class="table-data" style="margin-top:15px;">
            <thead>
               <tr>
                  ...
                  <th>Pelapor</th>
                  <th>Divisi</th>
                  <th>Alasan Kerusakan Jaringan</th>
