...
<div class="page-header d-print-none">
   <div class="container-xl">
      <div class="row g-2 align-items-center">
         ...
         <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
               <a href="{{ route('puskom.webassignmentreport.index') }}" class="btn btn-secondary d-none d-sm-inline-block">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
                     <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                  ...
                  <tr>
                     ...
                     <td>
                        <div class="btn-list justify-content-end flex-nowrap">
                           <a href="{{ route('puskom.webassignmentreport.showByIndex', ['year' => $item->year]) }}"
                              class="btn btn-outline-info">
                              Lihat
                           </a>
                           @if ($item->allSignaturesExist())
                              <a href="{{ route('puskom.webassignmentreport.print', ['year' => $item->year]) }}" class="btn btn-warning">
                                 Cetak
                              </a>
                     ...
                     <x-verify-signature route="{{ route('puskom.webassignmentreport.verify', ['year' => $item->year]) }}" method='post' id='{{ $loop->index }}' title="Paraf Puskom" name="puskom_signature"></x-verify-signature>
                  </tr>
                  @empty
                  <tr>
                     <td colspan="6">
