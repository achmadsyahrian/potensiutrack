...
<head>
   ...
   <title>Print Permohonan Pembuatan Web</title>
   <style>
      body {
         ...
         <thead>
            <tr>
               ...
               <td class="header-cell" style="width: 30%;">
                  <strong>NO. DOKUMEN</strong><br>F-/SPMI/27-03-01
               </td>
            </tr>
            <tr>
               <td colspan="2" rowspan="2" class="header-cell">
                  <strong>JUDUL</strong><br>PERMOHONAN PEMBUATAN WEB DEVELOPMENT DAN APLIKASI SISTEM INFORMASI
               </td>
               <td class="">
