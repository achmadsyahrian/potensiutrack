         ...
         <thead>
            <tr>
               ...
               <td class="header-cell" style="width: 30%;">
                  <strong>NO. DOKUMEN</strong><br>F-/SPMI/27-02-03
               </td>
            </tr>
            <tr>
               <td colspan="2" rowspan="2" class="header-cell">
                  <strong>JUDUL</strong><br>PENUGASAN PENGEMBANGAN DAN PENANGANAN KONEKSI JARINGAN UTAMA
               </td>
               <td class="">
      ...
      <div class="container" style="position:absolute; bottom:0; width:100%; left:0;">
         ...
         <table class="table-data" style="margin-top:15px;">
            <thead>
               <tr>
                  <th rowspan="2">No.</th>
                  <th rowspan="2">IT Administrator</th>
                  <th rowspan="2">Ruangan Divisi</th>
            ...
            <tbody>
               @foreach ($dataChunk as $item)
                  <tr>
                     ...
                     <td>
                        {!! $item->assignment_type == 'troubleshooting' ? '<div style="font-family: DejaVu Sans, sans-serif;">&#10003;</div>' : '' !!}
                     </td>
                     <td>
                     ...
                     <td style="padding:0;">
                        <img src="{{ asset('storage/'.$item->engineer_signature) }}" alt="Paraf Pelapor" width="50">
                     </td>
                     <td style="padding:0;">
                        <img src="{{ asset('storage/'.$item->kabag_signature) }}" alt="Paraf Pelapor" width="50">
                     </td>
                  </tr>
               @endforeach
            </tbody>
