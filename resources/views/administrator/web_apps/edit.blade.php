         ...
         <div class="col">
            <div class="page-pretitle">
               <ol class="breadcrumb breadcrumb-arrows">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('webapps.index') }}">Web Aplikasi</a></li>
   ...
   <div class="container-xl">
      <div class="card">
         <div class="row row-deck row-cards">
            <form action="{{ route('webapps.update', ['web_application' => $web_application]) }}" method="post" enctype="multipart/form-data">
               @csrf
               @method('put')
               <div class="col d-flex flex-column">
                     ...
                     <div class="row g-3 mt-4">
                        <div class="col-md">
                           ...
                           <input type="text" placeholder="Masukkan nama"
                              class="form-control @error('name') is-invalid @enderror" value="{{ $web_application->name }}"
                  ...
                  <div class="card-footer bg-transparent mt-auto">
                     <div class="btn-list justify-content-end">
                        <a href="{{ route('webapps.index') }}" class="btn">
                           Kembali
                        </a>
