         ...
         <div class="col">
            <div class="page-pretitle">
               <ol class="breadcrumb breadcrumb-arrows">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('lecturers.index') }}">Dosen</a></li>
   ...
   <div class="container-xl">
      <div class="card">
         <div class="row row-deck row-cards">
            <form action="{{ route('lecturers.update', ['lecturer' => $user->id]) }}" method="post" enctype="multipart/form-data">
               @csrf
               @method('patch')
               <div class="col d-flex flex-column">
                  <div class="card-body">
                     ...
                     <div class="row g-3 mt-4">
                        ...
                        <div class="col-md">
                           ...
                           <input type="text" placeholder="Masukkan nip"
                              class="form-control @error('nip') is-invalid @enderror" value="{{ $user->nip}}"
                              name="nip" autocomplete='off'>
                     ...
                     <p class="card-subtitle">Harap masukkan nomor yang valid.</p>
                     <div>
                        <div class="row g-2">
                           <div class="col-md">
                              <input type="text" placeholder="Masukkan nomor"
                                 class="form-control @error('phone') is-invalid @enderror"
                                 value="{{ $user->phone}}" name="phone" autocomplete='off'>
                  ...
                  <div class="card-footer bg-transparent mt-auto">
                     <div class="btn-list justify-content-end">
                        <a href="{{ route('lecturers.index') }}" class="btn">
                           Kembali
                        </a>
