                      ...
                      <tr>
                        ...
                        <td>
                           <div class="btn-list justify-content-end flex-nowrap">
                              <a href="{{ route($route . '.edit', [$name => $item]) }}" class="btn btn-outline-info">
                                 Edit
                             </a>
                        ...
                        <x-confirm-modal route="{{ route($route . '.destroy', [$name => $item->id]) }}" method='delete' id='{{ $item->id }}'></x-confirm-modal>
                     </tr>
                  @empty
                     <tr>
                        <td colspan="5">
...
<x-administrator.accounts.modal title="{{ ucfirst($title) }} Baru" route="{{ $route . '.store' }}" />
