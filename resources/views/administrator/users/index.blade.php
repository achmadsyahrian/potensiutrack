               ...
               <tbody>
                  @forelse ($users as $item)
                      <tr>
                        ...
                        <td>
                           <span class="badge bg-success me-1"></span> {{ $item->role->name }}
                        </td>
                        <td>
                           <div class="btn-list justify-content-end flex-nowrap">
                              <a href="{{ route('users.edit', ['user' => $item->id]) }}" class="btn btn-outline-info">
                                 Edit
                             </a>
                        ...
                        <x-confirm-modal route="{{ route('users.destroy', ['user' => $item->id]) }}" method='delete' id='{{ $item->id }}'></x-confirm-modal>
                     </tr>
                  @empty
                     <tr>
                        <td colspan="5">
