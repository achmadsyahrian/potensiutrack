         ...
         <thead>
            <tr>
               ...
               <td class="header-cell">
                  <strong>DOKUMEN LEVEL</strong><br>LOGBOOK
               </td>
               <td class="header-cell" style="width: 30%;">
                  <strong>NO. DOKUMEN</strong><br>F-/SPMI/26-01-08
               </td>
            </tr>
            <tr>
               <td colspan="2" rowspan="2" class="header-cell">
                  <strong>JUDUL</strong><br>PERMOHONAN PERAWATAN DAN PERBAIKAN
               </td>
               <td class="">
                  <span style="width: 120px; display: inline-block"> Tanggal Terbit </span> : 07 Nov 2014
               </td>
            </tr>
            <tr>
               <td class="">
                  <span style="width: 120px; display: inline-block"> Tanggal Efektif </span> : 14 Nov 2014
               </td>
            </tr>
            <tr>
               <td colspan="2" rowspan="2" class="header-cell">
            ...
            <tbody>
               @foreach ($dataChunk as $item)
                  <tr>
                     ...
                     <td>{{ $item->repair_solution }}</td>
                     <td>{{ \Carbon\Carbon::parse($item->return_date)->locale('id_ID')->isoFormat('D MMMM YYYY') }}</td>
                     <td style="padding:0;">
                           <img src="{{ asset('storage/'.$item->employee_signature) }}" alt="Tanda Tangan Dosen" width="50">
                     </td>
                     <td style="padding:0;">
                           <img src="{{ asset('storage/'.$item->technician_signature) }}" alt="Paraf Aslab" width="50">
                     </td>
                     <td style="padding:0;">
                        <img src="{{ asset('storage/'.$item->kabag_signature_approval) }}" alt="Paraf Aslab" width="50">
                     </td>
                  </tr>
               @endforeach
            </tbody>
