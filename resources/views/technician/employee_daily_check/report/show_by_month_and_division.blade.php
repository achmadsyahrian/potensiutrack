   ...
   <div class="container-xl">
      <div class="row g-2 align-items-center">
         <div class="col">
            <div class="page-pretitle">
               <ol class="breadcrumb breadcrumb-arrows">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('technician.employeepcdailychecksreport.index') }}">Pemeriksaan PC Harian Staff</a></li>
                  <li class="breadcrumb-item active"><a href="#"> {{ $month }} {{ $year }}</a></li>
                  <li class="breadcrumb-item active"><a href="#">{{ $divisionName }}</a></li>
               </ol>
            </div>
            <h2 class="page-title">
               Potensi Utama Track
         ...
         {{-- <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
               <a href="{{ route('technician.employeepcdailychecksreport.index') }}" class="btn btn-warning d-none d-sm-inline-block">
                    ...
                    <td>
                     ...
                     <td>
                        <div class="btn-list justify-content-end flex-nowrap">
                           <a href="{{ route('technician.employeepcdailychecksreport.show', ['id' => $item]) }}"
