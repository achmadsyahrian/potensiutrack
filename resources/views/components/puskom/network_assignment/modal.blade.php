<div class="modal modal-blur fade" id="modal-report" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form action="{{ route('puskom.networkassignment.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('post')
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label class="form-label required">IT Administrator</label>
                    <div class="form-selectgroup-boxes row mb-3">
                       @foreach ($engineers as $item)
                       <div class="col-lg-6 mb-3">
                          <label class="form-selectgroup-item">
                             <input type="radio" name="engineer_id" value="{{ $item->id }}" class="form-selectgroup-input @error('engineer_id') is-invalid @enderror" {{ old('engineer_id') == $item->id ? 'checked' : '' }}>
                             <span class="form-selectgroup-label d-flex align-items-center p-3 @error('engineer_id') border-danger @enderror">
                                <span class="me-3">
                             ...
                             <x-invalid-feedback field='engineer_id'></x-invalid-feedback>
                          </label>
                       </div>
                       @endforeach
                    </div>
                    ...
                    <div class="form-selectgroup-boxes row mb-3">
                        <div class="col-lg-6 mb-3">
                            <label class="form-selectgroup-item">
                               <input type="radio" name="assignment_type" value="troubleshooting" class="form-selectgroup-input @error('assignment_type') is-invalid @enderror">
                               <span class="form-selectgroup-label d-flex align-items-center p-3 @error('assignment_type') border-danger @enderror">
                                  <span class="me-3">
                                     <span class="form-selectgroup-check"></span>
                                  </span>
                                  <span class="form-selectgroup-label-content">
                                     <span class="form-selectgroup-title strong mb-1">Penanganan</span>
                                  </span>
                               </span>
