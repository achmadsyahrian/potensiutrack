<div class="modal modal-blur fade" id="modal-report" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form action="{{ route('puskom.networkdev.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('post')
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label required">Alasan Penambahan Jaringan</label>
                                <textarea data-bs-toggle="autosize" placeholder="Ketikkan disini" class="form-control @error('network_expansion_reason') is-invalid @enderror" name="network_expansion_reason" id="" cols="" rows="7">{{ old('network_expansion_reason') }}</textarea>
                                <x-invalid-feedback field='network_expansion_reason'></x-invalid-feedback>
                            </div>
                        </div>
                    </div>
                </div>
