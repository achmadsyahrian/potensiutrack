                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <select type="text" class="form-select" name="search_employee">
                                    <option selected disabled>Pilih pemohon</option>
                                    @foreach ($employees as $item)
                                        <option value="{{ $item->id }}" {{ request('search_employee') == $item->id ? 'selected' : '' }}>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                  </select>
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <select type="text" class="form-select" name="search_technician">
                                    <option selected disabled>Pilih penanggung jawab</option>
                                    @foreach ($technicians as $item)
                                        <option value="{{ $item->id }}" {{ request('search_technician') == $item->id ? 'selected' : '' }}>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                  </select>
