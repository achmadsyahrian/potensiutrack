<div class="modal modal-blur fade " id="modal-search" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="{{ route('sectionhead.webassignment.index') }}" method="get">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <select type="text" class="form-select" name="search_programmer">
                                    <option selected disabled>Pilih programmer</option>
                                    @foreach ($programmers as $item)
                                        <option value="{{ $item->id }}" {{ request('search_programmer') == $item->id ? 'selected' : '' }}>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                  </select>
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="search_application" placeholder="Masukkan aplikasi" value="{{ request('search_application') }}" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>
