@props(['route', 'method', 'id'])

<div class="modal modal-blur fade" id="modal-report-{{ $id }}" tabindex="-1" role="dialog" aria-hidden="true">
           ...
           <div class="modal-content">
               ...
               <div class="modal-body">
                   <div class="row">
                       <div class="col-lg-12">
                           <div class="mb-3">
                               <x-sectionhead.signature-canvas title="Paraf Kabag" name="kabag_signature" id="{{ $id }}"></x-sectionhead.signature-canvas>
                           </div>
                       </div>
                   </div>
               </div>
